...
const CartPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 font-sora">
      <h1 className="text-[25px] md:text-[50px] font-semibold md:font-bold text-center mb-8">
        Cart
      </h1>
          ...
          <div className="lg:col-span-7 space-y-[26px] border-b border-[#989898] md:border-0">
            {cart.map((item, index) => (
              <div
                ...
                className="flex gap-[14px] md:gap-6 pb-6 "
              >
                ...
                <div className="flex-grow">
                  <h3 className="text-[18px] md:text-[20px] text-[#121212]">
                    {item.title}
                  </h3>
                  <p className="text-[15px] md:text-[17px] text-[#222222] mb-4 md:mb-5">
                    {item.options?.size || "100gm"}
                  </p>
                  <p className="text-[24px] md:text-[28px] font-semibold text-[#0B6B00] mb-2 md:mb-3">
                    Rs.{item.price}
                  </p>
          ...
          <div className="lg:col-span-5">
            <div className="lg:border-l lg:pl-12 border-[#989898] h-full">
              ...
              <p className="text-sm text-gray-500 mb-8 leading-relaxed">
                Note: Taxes, shipping fees, and discount codes will be applied
                at checkout.
              </p>
              ...
              <Link
                href="/product"
                className="w-full flex items-center justify-center gap-2 text-gray-700 font-medium hover:gap-3 transition-all"
              >
