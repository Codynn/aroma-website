    ...
    <div className="max-w-7xl flex flex-col items-center justify-center mx-auto px-4 min-h-screen">
      ...
      <div className="w-full flex justify-between items-center mb-12">
            ...
            <DialogContent className="max-w-2xl bg-transparent border-none shadow-none p-0 focus:ring-0">
              ...
              <div className="p-8 bg-[#F1F8EC] rounded-[24px] w-full border border-[#7D8F7B]/10 shadow-xl">
                <div className="flex flex-col gap-10">
                  <div>
                    <h4 className="font-sora font-bold text-gray-900 mb-6 text-[18px]">
                      Category
                    </h4>
                      ...
                      {[
                        ...
                        >
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              setTempCategory(type === tempCategory ? "" : type)
                            }
                            className="border-[#7D8F7B] w-5 h-5 data-[state=checked]:bg-[#77923B]"
                          />
                          <label
                            htmlFor={type}
                            className="text-[15px] font-sora text-gray-700 cursor-pointer group-hover:text-[#77923B] transition-colors"
                          >
                            {type}
                          </label>
                        </div>
                  ...
                  <div className="w-full">
                    <div className="flex justify-between items-end mb-8">
                      <h4 className="font-sora font-bold text-gray-900 text-[18px]">
                        Price Range
                      </h4>
                      ...
                      <div className="flex-1 bg-white/60 backdrop-blur-sm border border-[#7D8F7B]/20 rounded-xl px-4 py-3 shadow-inner">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <input
                            ...
                            className="w-full bg-transparent font-sora font-bold outline-none"
                          />
                        </div>
                      </div>
                      <div className="flex-1 bg-white/60 backdrop-blur-sm border border-[#7D8F7B]/20 rounded-xl px-4 py-3 shadow-inner">
                ...
                <div className="flex justify-end gap-3 mt-12">
                  ...
                  <DialogClose asChild>
                    <button
                      ...
                      className="px-10 py-3 bg-[#77923B] text-white rounded-xl font-sora font-bold hover:shadow-lg transition-all"
                    >
                      Apply Filter
                    </button>
                  </DialogClose>
        ...
        <div className="md:hidden">
          <Sheet>
            ...
            <SheetContent
              side="bottom"
              className="rounded-t-[32px] p-0 border-none h-[85vh] bg-[#F1F8EC]"
            >
              ...
              <div className="px-6 pb-12">
                <div className="flex flex-col gap-10">
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {[
                        ...
                        <div
                          key={type}
                          className="flex items-center space-x-3 bg-white/50 p-3 rounded-xl"
                        >
                          <Checkbox
                            id={`mob-${type}`}
                            checked={tempCategory === type}
                          ...
                          <label
                            htmlFor={`mob-${type}`}
                            className="text-[15px] font-sora text-gray-700 w-full"
                          >
                            {type}
                          </label>
                        </div>
                  ...
                  <div className="w-full">
                    <h4 className="font-sora font-bold text-gray-900 text-[18px] mb-4">
                      Price Range
                    </h4>
                    <Slider
                      value={priceRange}
                  ...
                  <div className="flex flex-col gap-3 mt-4">
                    <SheetTrigger asChild>
                      <button
                        onClick={handleApplyFilters}
                        className="w-full py-4 bg-[#77923B] text-white rounded-xl font-sora font-bold shadow-lg"
                      >
                        Apply Filter
                      </button>
                    </SheetTrigger>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-2 px-5 py-2 md:px-7 md:py-3 border bg-[#77923B] rounded-[16px] outline-none">
              <span className="font-sora text-white text-[12px] md:text-[18px]">
                {appliedFilters.sortBy === "soldQuantity"
                  ? "Most Popular"
                  : "Latest"}
              </span>
          ...
          <DropdownMenuContent
            align="end"
            className="w-[200px] rounded-xl font-sora p-2"
          >
            <DropdownMenuItem
      ...
      {isLoading ? (
              ...
              >
                ...
                <div className="flex justify-between items-start px-1">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-sora font-medium text-[12px] md:text-[14px]">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 py-12">
          ...
          <p className="text-center text-[42px] text-black leading-1">
            Product coming Soon
          </p>

          {/* Text Content */}
          <h2 className="text-[#1A1A1A] font-sora font-extrabold text-[18px] md:text-[28px]  leading-tight mb-4">
            Everything you need <br className="hidden md:block" /> to know about
            our tea
          </h2>
