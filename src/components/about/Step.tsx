...
const timelineSteps: TimelineStep[] = [
  {
    id: 1,
    title: "High-Altitude Tea Gardens",
    description: "Our journey begins in the misty hills of Ilam, Nepal, where tea gardens thrive at premium Himalayan altitudes. The clean mountain air, fertile soil, and ideal climate create the perfect environment for producing exceptional tea.",
    imageUrl: "/Images/step1.png",
    Icon: '/Images/highaltitude.png',
  },
  {
    id: 2,
    title: "Careful Handpicking",
    description: "Skilled local farmers carefully handpick the freshest tea leaves, selecting only the finest buds and young leaves to ensure the highest quality and flavor in every harvest.",
  ...
  },
  {
    ...
    description: "The leaves are gently withered, rolled, and processed using traditional techniques that preserve their natural aroma, rich flavor, and distinctive Himalayan character.",
  ...
  },
  {
    ...
    description: "Every batch is carefully inspected and selected to meet our premium standards, ensuring consistency, purity, and the authentic taste of Himalayan tea.",
    imageUrl: "/Images/step4.png",
    Icon: '/Images/quality.png',
  },
  {
    id: 5,
    title: "Respoinsible Packaging",
    description: "Our teas are carefully packaged to maintain freshness while using responsible materials that reflect our commitment to sustainability and quality.",
    imageUrl: "/Images/step5.png",
    Icon: '/Images/packaging.png',
  },
  {
    id: 6,
    title: "From Himalayas to Your Cup",
    description: "Finally, our tea is shipped worldwide, bringing the purity and essence of the Himalayan hills directly to tea lovers across the globe.",
